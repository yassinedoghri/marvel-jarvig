...
const Button = styled.button`
    ...
    ${props => {
      ...
      if (props.accent)
        return backgrounds(
          'url("/image/background.jpg")',
          `linear-gradient(45deg, ${props.theme.colors.accent.base},${
      ...
      if (props.accent2)
        return backgrounds(
          'url("/image/background.jpg")',
          `linear-gradient(45deg, ${props.theme.colors.accent2.base},${
            props.theme.colors.accent2.light
          })`,
          "center no-repeat"
        );
      return backgrounds(
    ...
    &:active {
        ${props => {
          if (props.primary)
            return backgrounds(
              'url("/image/background.jpg")',
              `linear-gradient(45deg, ${props.theme.colors.primary.dark},${
          ...
          if (props.accent)
            return backgrounds(
              'url("/image/background.jpg")',
              `linear-gradient(45deg, ${props.theme.colors.accent.dark},${
          ...
          if (props.accent2)
            return backgrounds(
              'url("/image/background.jpg")',
              `linear-gradient(45deg, ${props.theme.colors.accent2.dark},${
                props.theme.colors.accent2.base
              })`,
              "center no-repeat"
            );
          if (props.play)
          ...
          return backgrounds(
            'url("/image/background.jpg")',
            `linear-gradient(45deg, ${props.theme.colors.def.dark},${
              props.theme.colors.def.light
            })`,
            "center no-repeat"
          );
